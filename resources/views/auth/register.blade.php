...
<a href="{{ url('/admin/home') }}"><div class="k">Login</div></a>
<div class="login-box"  >
   <h2>@lang('quickadmin.qa_register')</h2>
                  
                        <form role="form" method="POST" action="{{ url('/register') }}">
                            {{ csrf_field() }}
                            <div class="user-box">
                                   <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus>
                                   <label>@lang('quickadmin.qa_name')</label>
                                   @if ($errors->has('name'))
      ...
      <label for="password-confirm" >Confirm it</label>
      
    </div>
    <center><a><span></span><span></span><span></span><span></span>             
